...
use WykopBundle\Entity\Tag;
use WykopBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WykopBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("WykopBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WykopBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WykopBundle:Tag:edit.html.twig")
     */
